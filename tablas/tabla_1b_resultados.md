...
- **campeón · `cuello 10 · 15000 ep`** — no es un barrido: es el modelo final reforzado, evaluado a 10/15/20 %.
...
hiperparámetro con trade-off (E10). El campeón cuello 10 / 15 % es el equilibrio.
