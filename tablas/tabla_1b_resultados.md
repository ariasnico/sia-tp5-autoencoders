...
- *(El modelo ganador —cuello 10, 15000 ep— ya no figura en esta tabla-resumen para no adelantar el número:
  su resultado contundente, **81 % ≤1px @15 %** / 92 % @10 % / 64 % @20 %, se muestra en su propia slide.)*
